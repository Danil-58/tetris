export default class View{
    ...
    constructor(element, width, height, rows, columns){
        ...
        this.playfiledInnerWidth = this.playfiledWidth - this.playfiledBorderWidth * 2;
        this.playfiledInnerHeight = this.playfiledHeight - this.playfiledBorderWidth * 2;


        this.blockWidth = this.playfiledInnerWidth / columns;
        this.blockHeight = this.playfiledInnerHeight  / rows;
        this.panelX = this.playfiledWidth + 10;
        this.panelY = 0;
    ...
    rendePlayfiled({playfiled}){
        for (let y = 0; y < playfiled.length; y++) {
            const line = playfiled[y];
